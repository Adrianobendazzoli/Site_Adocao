...
<body class="bg-gray-50 text-gray-800">
    ...
    <div class="max-w-6xl mx-auto mt-12 p-4">
        ...
        <div>
            <button class="px-3 py-1 text-sm bg-violet-600 text-white rounded hover:bg-violet-700 btn-verpets" href="pets_admin.php" onclick="window.location.href='pets_admin.php'">
                Ver todos os pets
            </button>
        </div>
    </div>
