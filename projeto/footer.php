...
/*
AUTO-COMMENTED FILE
Original path: site-adocao1/projeto/footer.php
Summary (auto-generated):
general file (no strong heuristics matched)
  ...
  <div class="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
    <div class="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
      <div class="md:w-[316px]">
        <img src="img-site/logotipo.png" alt="" class="w-[150px]">

        <p class="mt-[18px] text-[15px] font-normal text-white/[80%]">Somos um projeto de adoção de qualquer tipo de pet! Com sistema de localização para calcular sua distância até o seu futuro pet.</p>
      </div>
      <div class="mt-6 flex w-full flex-col justify-between text-white sm:flex-row md:mt-0 md:max-w-[341px]">
        <div class="">
          ...
          <ul>
            ...
            <li class="mt-[15px]"><a
                class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                href="pets.php">Meus pets</a></li>
            <li class="mt-[15px]"><a
                class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                href="faq.php">FAQ</a></li>
            <li class="mt-[15px]"><a
                class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[15px] font-normal hover:font-semibold"
                href="localizar_dono.php">Pets próximos</a></li>
          </ul>
        </div>
